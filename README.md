...
python main.py
```
Most projects use standard library only. Some require `requests`, `matplotlib`, `pandas`. Check individual folders for `requirements.txt`.
...
1. **Python Fundamentals**: Variables, loops, functions, error handling
2. **GUI with Tkinter**: Buttons, labels, entry, layouts, event handling
3. **Working with APIs**: Fetching live data with `requests` 
4. **File I/O**: Reading/writing CSV, JSON, and text files
5. **Basic OOP**: Using classes to structure projects
6. **Data Visualization**: Plotting with Matplotlib

## 📸 Screenshots
> Tip: Add a `/screenshots` folder and showcase your best UIs here
...
3. Add your project folder with a `README.md` inside
4. Commit: `git commit -m "Add NewProject"`
5. Push: `git push origin feature/NewProject`
